// This is the servo evaluator example from the library
// uses two different types of servos since they have somewhat different mapping
#include "PCA9685.h"
...
// TODO: find the min, mid, max PWM mappings for MG996R, should be similar but check just in case!
